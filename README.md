...
<h1 align="center">Teste-AdviceHealth</h1>
...
Desenvolver aplicações para a área da Saúde é sempre
um desafio. A complexidade e a dinâmica do negócio e
os usuários leigos, exigem soluções simples e objetivas,
porém, que atendam toda a complexidade que envolve a
área. Tendo telas intuitivas e de fácil utilização, que
abstraem a complexidade do negócio e que gerem valor
ao usuário final, agilizando o seu dia a dia, para que este
possa focar no paciente.

Problemática

Desenvolva o front-end da solução proposta, para um WebApp de consultório
médico, prevendo as seguintes telas:
...
- 🛠 Ferramenta proderosa no gerenciamento de uma clínica.
