...
function Dashboard() {
      ...
      return <Container>
            <div className="p-3" style={{ backgroundColor: (title === 'dark' ? colors.tertiary : colors.white), borderRadius: '8px' }}>
                  ...
                  <div className="flex mb-5" style={{ height: 'calc(100vh - 350px)' }} >
                        <div className="w-4/12 mr-3">
                              <GridCustom options={options} title="Quadro de médicos" tipo="M" />
                        </div>
                        <div className="w-4/12 mr-3">
                              <SummaryCustom id="1" className="mb-2  p-2">
                                    <label className="font-bold" htmlFor="" style={{ fontFamily: 'Dosis' }}>Pacientes agendado</label>
                                    <div className="w-full text-center">
                                          <CountUp className="font-bold lg:text-8xl" end={30} prefix='' separator="." decimal="" decimals={0} style={{ color: colors.secondary, fontFamily: 'Dosis' }} />
                                    </div>
                              </SummaryCustom>
                              <SummaryCustom id="1" className=" p-2">
                                    <label className="font-bold" htmlFor="" style={{ fontFamily: 'Dosis' }}>Pacientes atendidos</label>
                                    <div className="w-full text-center">
                                          <CountUp className="font-bold lg:text-8xl" end={5} prefix='' separator="." decimal="" decimals={0} style={{ color: colors.tertiary, fontFamily: 'Dosis' }} />
                                    </div>
                              </SummaryCustom>
                        </div>
                  ...
                  <div className="w-full grid grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-3">
                        <SummaryCustom className='mb-2 lg:mb-0 lg:col-start-1 lg:col-span-2 ' id="total-dinheiro" children={cardLembrete} colorBorder={colors.primary} />
